            ...
            <ul class="h-[78vh] overflow-y-auto">
                ...
                @forelse($users as $user)
                    <li class="flex flex-col items-end justify-between py-2 border-b border-gray-700">
                        ...
                        <div class="flex">
                            <button class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg mr-2">Accept</button>
                            <button class="bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded-lg mr-2">Ignore</button>
                        </div>
                    </li>
                @empty

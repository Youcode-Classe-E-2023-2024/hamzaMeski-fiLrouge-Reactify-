        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-4 gap-y-6">
                ...
                @foreach($users as $user)
                    <div class="bg-white p-6 rounded-lg border-2 border-red-400 hover:bg-gradient-to-br from-red-700 to-violet-600 hover:border-white" style="box-shadow: 2px 1px 10px -6px rgba(180,0,69,0.47);">

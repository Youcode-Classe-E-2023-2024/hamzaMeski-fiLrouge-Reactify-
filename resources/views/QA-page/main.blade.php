...
@section('content')
    <section class="h-[91vh] flex">
        <section class="h-[91vh] flex">
            <ul class="bg-gradient-to-br from-violet-700 to-red-500 shadow-red-lg w-[280px] flex flex-col justify-between rounded-[30px] overflow-hidden border-[1px] border-solid border-gray-700 py-2" style="box-shadow: 8px 7px 11px -6px rgba(180,0,155,0.45);">
                <li class="flex  justify-between px-2 pr-0">
                    ...
                    <div class="bg-green-500 w-[50px] flex items-center justify-center rounded-tl-[30px] rounded-bl-[30px] cursor-pointer">
                ...
                <li class="px-4">
                    <a href="#" class="side_item flex items-center justify-between hover:text-blue-500">
                        ...
                        <div class="h-[25px] w-[25px] rounded-full bg-gray-200 flex items-center justify-center">
                            <div class="text-center">4</div> <!-- Added text-center class -->
                        </div>
                    </a>
                </li>
                ...
                <li class="px-4 font-bold hover:text-blue-500">Explore all collectives</li>
            </ul>
        </section>

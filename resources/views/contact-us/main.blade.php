    ...
    <div class="grid grid-cols-1 md:grid-cols-12 border">
        <div class="bg-gray-900 md:col-span-4 p-10 text-white">
            ...
            <div class="flex items-center mt-5">
                <svg class="h-6 mr-2 text-orange-600" fill="currentColor" version="1.1"
            ...
            <div class="flex items-center mt-5">
                <svg class="h-6 mr-2 text-orange-600" fill="currentColor" version="1.1" id="Capa_1"
        ...
        <form class="md:col-span-8 p-10">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="flex justify-between w-full px-3">
                    ...
                    <button
                        class="shadow bg-orange-500 hover:bg-orange-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-6 rounded"
                        type="submit">
                        Send Message
                    </button>
                </div>

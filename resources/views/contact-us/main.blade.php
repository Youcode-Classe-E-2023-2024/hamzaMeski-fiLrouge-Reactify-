        ...
        <div class="grid grid-cols-1 md:grid-cols-12 ">
            <div class="bg-gray-800 md:col-span-4 p-10 text-white">
                ...
                <div class="flex items-center mt-5">
                    <svg class="h-6 mr-2 text-green-400" fill="currentColor" version="1.1"
                ...
                <div class="flex items-center mt-5">
                    <svg class="h-6 mr-2 text-green-400" fill="currentColor" version="1.1" id="Capa_1"
            ...
            <form class="md:col-span-8 p-10">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <textarea rows="10"
                                  class="appearance-none block w-full bg-gray-700 text-gray-300 border border-gray-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"></textarea>
                    </div>
                    <div class="flex justify-between w-full px-3">
                        ...
                        <button
                            class="shadow bg-green-400 hover:bg-green-300 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-6 rounded"
                            type="submit">
                            Send Message
                        </button>
                    </div>

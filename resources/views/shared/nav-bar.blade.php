<header class="shadow-md z-4">
    <nav class=" flex items-center px-[114px] fixed bg-white shadow-md w-full">
        <!-- ***** Logo Start ***** -->
        ...
        <ul class="menu_items flex items-center justify-end gap-10 w-full inline-block" style="font-weight: 500">
            ...
            <li class="scroll-to-section"><div class="main-red-button"><a href="http://127.0.0.1:8000/login">Get Started</a></div></li>
        </ul>
        <!-- ***** Menu End ***** -->
    </nav>
</header>

    ...
    <section class="min-h-screen flex items-stretch text-white ">
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 bg-red-500">
            ...
            <div class="w-full py-6 z-20">
                ...
                <form action="{{ route('forget.password.post') }}" method="POST" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto text-gray-800">
                    @csrf
                    <div class="pb-2 pt-4">
                    ...
                    <div class="px-4 pb-2 pt-4">
                        <button class="uppercase block w-full p-4 text-lg rounded-full bg-green-500 hover:bg-green-400 text-white focus:outline-none">reset password</button>
                    </div>
                </form>
            </div>
        </div>

    ...
    <section class="min-h-screen flex items-stretch text-white ">
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 bg-red-500" >
            ...
            <div class="w-full py-6 z-20">
                ...
                <form action="{{ route('register.store') }}" method="POST" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto text-gray-800">
                    @csrf
                    <div class="pb-2 pt-4">
                        <input type="text" name="name" id="name" placeholder="Username" class="block w-full p-4 text-lg rounded-sm ">
                    ...
                    <div class="px-4 pb-2 pt-4">
                        <button type="submit" class="uppercase block w-full p-4 text-lg text-white rounded-full bg-green-500 hover:bg-green-400 focus:outline-none">sign up</button>
                    </div>
                </form>
            </div>
        </div>

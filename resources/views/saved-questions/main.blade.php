...
@section('content')
    <div class="grid sm:grid-cols-1 lg:grid-cols-2 gap-6 p-6 ">
        @forelse($savedQuestions as $question)
            <div class="bg-gradient-to-br from-gray-900 to-black p-4 rounded-md">
                <div class="w-full bg-gray-900 shadow-md rounded-lg overflow-hidden border border-gray-700">
                    <div class="p-6">
